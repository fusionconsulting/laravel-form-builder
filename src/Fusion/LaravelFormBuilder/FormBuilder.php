...
use Fusion\LaravelFormBuilder\Events\AfterFormCreation;
...
class FormBuilder
{
     ...
     *
     * @param string $formClass The name of the class that inherits \Fusion\LaravelFormBuilder\Form.
     ...
     *
     * @param \Fusion\LaravelFormBuilder\Form $instance
     * @param array $options
     * @param array $data
     * @return \Fusion\LaravelFormBuilder\Form
     */
