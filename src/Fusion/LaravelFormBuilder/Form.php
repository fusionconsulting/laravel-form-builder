...
namespace Fusion\LaravelFormBuilder;
...
use Fusion\LaravelFormBuilder\Events\AfterFieldCreation;
use Fusion\LaravelFormBuilder\Events\AfterFormValidation;
use Fusion\LaravelFormBuilder\Events\BeforeFormValidation;
use Fusion\LaravelFormBuilder\Fields\FormField;
use Fusion\LaravelFormBuilder\Filters\FilterResolver;
...
class Form
{
    ...
    public function rebuildForm()
    {
        ...
        if (get_class($this) === 'Fusion\LaravelFormBuilder\Form') {
     ...
     *
     * @return \Fusion\LaravelFormBuilder\Form
     */
