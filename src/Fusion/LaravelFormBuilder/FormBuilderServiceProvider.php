...
use Fusion\LaravelFormBuilder\Traits\ValidatesWhenResolved;
...
class FormBuilderServiceProvider extends ServiceProvider
{
    ...
    {
        $this->commands('Fusion\LaravelFormBuilder\Console\FormMakeCommand');
        ...
        $this->app->alias('laravel-form-builder', 'Fusion\LaravelFormBuilder\FormBuilder');
    ...
    protected function registerFormHelper()
    {
        ...
        $this->app->alias('laravel-form-helper', 'Fusion\LaravelFormBuilder\FormHelper');
    }
